          ...
          <div className="grid gap-10 lg:grid-cols-3">
            <div className="lg:col-span-2">
              ...
              <div className="premium-card mb-10 rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface-raised)] p-6 shadow-[var(--shadow-card)] md:p-8">
                ...
                <p className="mb-4 text-sm text-[var(--color-text-muted)]">Check these requirements before you apply. Admissions can help clarify your eligibility.</p>
                <ul className="space-y-2 text-[var(--color-text-secondary)] leading-relaxed">
                  {course.entryRequirements.map((req) => (
                    <li key={req} className="flex items-start gap-2 text-sm"><span className="mt-1 h-2 w-2 shrink-0 rounded-full bg-[var(--color-accent)]" aria-hidden />{req}</li>
                  ))}
                </ul>
              </div>
              ...
              {course.certification && (
                <div className="premium-card mb-10 rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface-raised)] p-6 shadow-[var(--shadow-card)] md:p-8">
                  ...
                  <p className="mt-4 border-t border-[var(--color-border)] pt-4 text-xs leading-relaxed text-[var(--color-text-muted)]">Recognition and certification details apply specifically to this programme. Confirm current details with Admissions before registration.</p>
                </div>
              )}
              <p className="mb-10 rounded-xl border border-[var(--color-accent)]/25 bg-[var(--color-accent)]/10 px-5 py-4 text-sm leading-relaxed text-[var(--color-text-secondary)]"><strong className="text-[var(--color-text-primary)]">Please note:</strong> Completing a programme does not guarantee employment. Career outcomes depend on your experience, performance, employer requirements and job-market conditions.</p>
            </div>

            <div className="lg:col-span-1">
              <div className="sticky top-24 space-y-6">
                <div className="premium-card rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface-raised)] p-6 shadow-[var(--shadow-lg)]">
                ...
                <div className="premium-card rounded-2xl border border-[var(--color-primary)]/20 bg-gradient-to-br from-[var(--color-primary)]/[0.06] via-white to-[var(--color-accent)]/[0.08] p-6 shadow-[var(--shadow-lg)]">
                  <span className="mb-2 inline-block text-[10px] font-bold uppercase tracking-[0.18em] text-[var(--color-accent-dark)]">Admissions guidance</span>
                  <h3 className="mb-3 text-base font-bold text-[var(--color-text-primary)]">
                    Ready to explore this course?
                  </h3>
                  <p className="mb-5 text-sm text-[var(--color-text-secondary)]">
                    Ask about entry requirements, study options, fees and the next step before you apply.
                    {course.price !== "Free" && course.price !== "Contact for fees" ? (
                      ...
                      <span className="mt-2 block font-semibold text-[var(--color-primary)]">Request the current fee quotation from Admissions.</span>
                    )}
                  </p>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[var(--color-primary)] via-[var(--color-primary-dark)] to-[#0B1F3F] py-16 md:py-24">
        ...
        <Container className="relative z-10">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="mb-4 text-[var(--fs-3xl)] font-extrabold text-white">Ready to Start?</h2>
            <p className="mx-auto mb-8 max-w-2xl text-lg text-white/80">
              Take the next step in your education. Apply now or contact us for more information about this programme.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button variant="accent" size="lg" href={`/apply?course=${encodeURIComponent(course.title)}`} className="shadow-lg shadow-[var(--color-accent)]/25">
                Apply Now
              </Button>
