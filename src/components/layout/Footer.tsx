      ...
      <div className="border-b border-[var(--color-gray-800)]">
        <Container className="py-10 lg:py-12">
          <div className="max-w-xl mx-auto text-center">
            ...
            <form action="#" className="flex max-w-md mx-auto shadow-sm rounded-lg overflow-hidden">
              <input
                type="email"
                placeholder="Enter your email"
                required
                className="flex-1 px-5 py-3 text-sm text-[var(--color-text-primary)] bg-[var(--color-white)] focus:outline-none focus:ring-2 focus:ring-inset focus:ring-[var(--color-accent)] placeholder:text-[var(--color-gray-400)]"
              />
              <button
                type="submit"
                className="px-6 py-3 text-sm font-semibold text-[var(--color-text-inverse)] bg-gradient-to-r from-[var(--color-accent)] to-[var(--color-accent-dark)] hover:from-[var(--color-accent-dark)] hover:to-[var(--color-accent-dark)] transition-all duration-200 shrink-0"
              >
                Subscribe
              </button>
            </form>
