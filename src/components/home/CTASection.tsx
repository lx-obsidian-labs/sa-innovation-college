...
export default function CTASection() {
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full bg-white/[0.03] blur-3xl" aria-hidden />
      <div
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Button
              ...
              size="lg"
              href="/apply"
              className="shadow-lg shadow-[var(--color-accent)]/25 hover:scale-105"
            >
              Apply Now
            </Button>
            <Button
              ...
              size="lg"
              href="/courses"
              className="!border-white/40 !text-white hover:!bg-white/10 hover:scale-105"
            >
              View Courses
            </Button>
            <Button
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/5 px-4 py-2 text-sm text-white/80 backdrop-blur-sm transition-all duration-200 hover:bg-white/10 hover:text-white hover:border-white/40"
            >
