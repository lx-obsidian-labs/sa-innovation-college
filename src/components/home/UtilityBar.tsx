      ...
      <div className="mx-auto flex max-w-[var(--container-max)] items-center justify-between px-[var(--container-padding)] h-[34px]">
        <div className="flex items-center gap-3">
          ...
          <a
            ...
            className="flex items-center gap-1 hover:text-[var(--color-accent)] transition-colors hidden sm:flex"
            target="_blank"
        ...
        <div className="flex items-center gap-3">
          <span className="hidden md:inline text-[var(--color-gray-400)]">Mon–Fri: 08:00–17:00</span>
          <a href="/apply" className="flex items-center gap-1 hover:text-[var(--color-accent)] transition-colors font-medium">
            <svg className="w-3 h-3 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
