...
export default function WhatsAppSupport() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[var(--z-fixed)] flex flex-col items-end gap-3">
      {isOpen && (
        <div className="bg-white rounded-xl shadow-xl border border-gray-100 p-4 w-72 animate-scaleIn origin-bottom-right">
          ...
          <p className="text-xs text-[var(--color-gray-500)] mb-3 bg-[var(--color-gray-50)] rounded-lg p-3">
          ...
          <a
            ...
            className="flex items-center justify-center w-full gap-2 bg-[#25D366] text-white text-sm font-semibold py-2.5 rounded-lg hover:bg-[#1ebe5d] transition-colors"
          >
      ...
      <button
        ...
        className="flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-[#25D366]/30 transition-all duration-300 hover:scale-110 hover:shadow-xl hover:shadow-[#25D366]/40"
